...
export function AttendanceListPage(props: AttendanceListPageProps) {
  ...
  const columns: ColumnType[] = [
    ...
    },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.check_in ? format(parseISO(record?.check_in as unknown as string), 'dd-MM-yyyy') : '',
    },
    {
      id: 'check_out',
      header: 'Check Out',
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.check_out ? format(parseISO(record?.check_out as unknown as string), 'dd-MM-yyyy') : '',
    },
