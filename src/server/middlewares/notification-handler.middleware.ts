...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Employee Addition.create': {
    roles: ['owner', 'administrator'],
    key: 'employee_addition',
    tenantPath: [],
    userPath: [],
  },
  'Leave Approval.update': { roles: ['hr-manager'], key: 'leave_approval', tenantPath: [], userPath: [] },
  'Policy Implementation.create': {
    roles: ['owner', 'hr-manager', 'employee'],
    key: 'policy_implementation',
    tenantPath: [],
    userPath: [],
  },
};
